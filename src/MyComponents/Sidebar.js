...
export const Sidebar = () => {
    ...
    return (
        <div className="sidebar sidebar-color col-2 p-0 ps-0 m-0 rounded-right shadow-max pt-2"> 
            ...
            <SideButton icon={"home-side.png"} iconh={18} iconw={18} classname={"big-font sidebutton sidebutton-color  p-2 d-flex justify-content-start align-items-center border-bottom"} id={'dashboard-btn'} name={'Dashboard'} path={'/'} />
