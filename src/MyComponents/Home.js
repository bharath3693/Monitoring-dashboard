...
const data01leg = [
    { name: 'Device A', value: 400, type: 'star' },
    { name: 'Device B', value: 300, type: 'star' },
    { name: 'Device C', value: 300, type: 'star' },
    { name: 'Device D', value: 200, type: 'star' },
];
// const data02 = [
//     { name: 'A1', value: 100 },
//     { name: 'A2', value: 300 },
...
export const Home = (props) => {
    ...
    const radcolors = ['rgba(255, 255, 255,0.9)', 'rgba(255, 255, 255,0.6)', 'rgba(255, 255, 255,0.9)', 'rgba(255, 255, 255,0.6)']
    ...
    return (
        <div className="col-10 p-0 pt-3 m-0">
            ...
            <div className="d-flex justify-content-between rounded p-2">
                ...
                <CountDevices bg={"flex-stretch var-prime-color text-info m-1 rounded shadow-max"} name={'Number of Edge Devices'} count={3} link={"data:image/png;base64,"} />
                <CountDevices link={"./gg-side.webp"} bg={"flex-stretch var-prime-color text-info m-1 rounded shadow-max"} name={'Number of Green Grass Devices'} count={props.table3.length} />
            ...
            <div className="d-flex justify-content-around p-2 rounded">
                <div className="flex-stretch bg-white m-1 p-0 rounded-top shadow-max">
                    <h4 className='text-center text-success p-2 bg-white m-0 rounded-top text-uppercase text-size text-bold'>Edge Gateway Types</h4>
                    <PieChart className="var-prime-color w-100" width={510} height={300} >
                ...
                <div className="flex-stretch bg-white m-1 p-0 rounded-top shadow-max">
                    <h4 className='text-center text-success p-2 bg-white m-0 rounded-top text-uppercase text-size text-bold'>Edge Device Types</h4>
                    <PieChart className="var-prime-color w-100" width={510} height={300} >
