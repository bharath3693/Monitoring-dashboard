      ...
      <nav className="navbar navbar-expand-lg navbar-bg p-1 block m-0 shadow-max pe-3" >
        <div className="container-fluid p-0">
          ...
          <div className="d-flex justify-content-end">
            <div onClick={goToProfile} className="cursor-pointer d-flex justify-content-end mx-2 align-items-end border border-top-0 border-bottom-0 px-1">
              <b className="profile-name m-0 mb-2 mx-1">{username} </b>
              <img className="" alt="profile pic" src="https://img.icons8.com/color/512/circled-user-male-skin-type-5.png" height={40} width={40}>
              </img>
            </div>
            <button id="btn-logout" className="btn btn-sm p-2" onClick={logout}>
